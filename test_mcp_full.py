    ...
    try:
        async with stdio_client(server_params) as (read, write):
            async with ClientSession(read, write) as session:
                ...
                print(f"Prediction Result: {loan_result.content[0].text}")
            ...
            print(f"Prediction Result: {heart_result.content[0].text}")
            ...
            print(f"Prediction Result: {stock_result.content[0].text}")
